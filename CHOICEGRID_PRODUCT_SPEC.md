...
- Optional primary-to-backup Venice donation extraction with runtime validation and source observability; no live LLM is required because the deterministic seeded fallback remains available
