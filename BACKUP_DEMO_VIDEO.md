...
| 2. Existing lot | Open `/inventory/LOT-104`; show available pounds, risk deadline, location, refrigeration, condition status, and missing-data guardrails; select **Generate outbound plans**. | “Almanac starts after receiving. It uses validated lot facts and never makes a food-safety decision.” |
...
| 6. Mission | Open `/missions/MSN-104`; pan across warehouse origin, vehicle context, route, stops, and windows. | “The route begins at the warehouse and contains no donor pickup; Almanac is not a scheduling product.” |
